                    ...
                    <Section className="text-left max-w-6xl mx-auto px-6">
                        <div className="flex justify-between items-center mb-12">
                            ...
                            <a
                                ...
                                className="flex items-center gap-2 px-4 py-2 backdrop-blur-md bg-white/5 border border-white/10 rounded-full text-[10px] uppercase tracking-widest text-white/70 hover:text-white hover:bg-white/10 transition-all group"
                            >
